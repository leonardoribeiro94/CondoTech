                ...
                <div class="row">
                    <div class="col-md-12 well formulario">
                        ...
                        <ul class="nav nav-pills" id="minhaTab">
                            <li class="active"><a data-toggle="pill" href="#gridAreasDeLazer"><strong>Áreas de lazer</strong></a></li>
                            <li><a data-toggle="pill" href="#gridAreasDeLazerReservadas"><strong>Minhas reservas</strong></a></li>
                        </ul>
                            ...
                            <div class="tab-pane fade" id="gridAreasDeLazerReservadas">
                                <div class="row">
                                    <div class="col-md-12">
                                        <asp:UpdatePanel runat="server">
                                            <ContentTemplate>
                                                <asp:GridView ID="grvAreasDeLazerReservadas" runat="server" DataKeyNames="IdReserva" CssClass="table table-responsive bs-pagination"
                                                    PagerSettings-Mode="NumericFirstLast" PagerSettings-FirstPageText="Primeira" PagerSettings-LastPageText="Última"
